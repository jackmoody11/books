...
class ListingTest < ActiveSupport::TestCase
  ...
  def setup
    @not_admin = users(:two)
    @admin = users(:one)
    @valid_listing = Listing.new(title: "Valid Title", price: 123, condition: "Used - Like New", user: @not_admin)
    @invalid_listing_price = Listing.new(title: "Valid Title", condition: "Used - Like New", user: @not_admin)
    @invalid_listing_title = Listing.new(price: 123, condition: "Used - Like New", user: @not_admin)
    @invalid_listing_condition = Listing.new(title: "Valid Title", price: 123, user: @not_admin, condition: "Not a choice")
    @listing_no_condition = Listing.new(title: "Valid Title", price: 123, user: @not_admin)
  ...
  test "listing without user does not save" do
    assert_not @invalid_listing_user.save, "listing without user saves"
  end
